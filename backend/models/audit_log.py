...
class ActionType(IntEnum):
    ...
    DELETE_COMMENT = 20
    RESTORE_COMMENT = 21
    HARD_DELETE_COMMENT = 22

    # 超级管理员操作
    ADMIN_DELETE_POST = 30
    ADMIN_RESTORE_POST = 31
    ADMIN_HARD_DELETE_POST = 32
    ADMIN_DELETE_COMMENT = 33
    ADMIN_HARD_DELETE_COMMENT = 34
    ADMIN_RESTORE_COMMENT = 35
